                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="meta__comments">
                                <span class="meta__date"><span class="glyphicon glyphicon-calendar"></span> {{ $post->date or '11 мая 2015 г.' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xs-10  col-xs-offset-1">
            <div class="post-content--front-page">
                <h2 class="front-page-title">
                    <a href="/post">{{ $post->title or 'Основной заголовок поста c картинкой' }}</a>
                </h2>
                <h3>Подзаголовок поста</h3>
                <p>
                    {{ $post->content or 'Высшая арифметика, исключая очевидный случай, позитивно соответствует стремящийся ротор векторного поля, как и предполагалось. Длина вектора вырождена. Постоянная величина транслирует коллинеарный детерминант. Теорема, очевидно, развивает комплексный полином. Матожидание, в первом приближении, традиционно проецирует аксиоматичный график функции.'}}
                </p>
            </div>
            <a href="/post">
                <div class="read-more">
