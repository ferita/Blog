    ...
    <div class="row">
        <div class="col-xs-10  col-xs-offset-1  col-md-8  col-md-offset-2  push-down-60">
            ...
            <div class="post-content">
                <h1>
                    <a href="#">{{ $post->title or 'Основной заголовок (H1)' }}</a>
                </h1>
                <h3>{{ $post->tags or 'Тэглайн поста размером H3' }}</h3>
                {{ $post->content or '<p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <div class="tags">
                       ...
                       //      <a href="{{ route('site.posts.byTag', ['tag' => $tag]) }}" class="tags__link">{{ $tag->name }}</a>
                       //  @empty
                       //      Пост не имеет тэгов
                       //  @endforelse
                        ?>
                        ...
                        <div class="comment clearfix">
                            ...
                            <div class="comment-body clearfix">
                                <div class="comment-header">
                                    <strong class="primary-font">{{ $comment->author or 'Иванов Иван' }}</strong>
                                    <small class="pull-right text-muted">
                                        <span class="glyphicon glyphicon-time"></span>{{ $comment->date or '15 мая 2015 10:12' }}
                                    </small>
                                </div>
                                <p class="comment-text">
                                     {{ $comment->comment or ' Культурная аура произведения, как бы это ни казалось парадоксальным, многопланово заканчивает определенный синтез искусств. Богатство ' }}
                                </p>
                            </div>
                        </div>
                   <?php 
